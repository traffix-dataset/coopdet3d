...
class GlobalRotScaleTransCoop:
    ...
    def __call__(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        #    visualize_feature_lidar(data["vehicle_points"].tensor.numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/val_globalrotscaletrans")
...
class VehiclePointsToInfraCoords:
    def __call__(self, data):
        ...
        # if not self.is_train:
        #    visualize_feature_lidar(data["vehicle_points"].tensor.numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/pipelinev2i")
        #    visualize_feature_lidar(data["infrastructure_points"].tensor.numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/pipelineinfra")
