...
class LoadPointsFromMultiSweepsCoop:
    ...
    def __call__(self, results):
        ...
        #    visualize_feature_lidar(vehicle_points, "/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/val_multisweep")
        return results
...
class LoadPointsFromFileCoop:
    ...
    def __call__(self, results):
        ...
        #if not self.training:
        #    visualize_feature_lidar(vehicle_points, "/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/val_loadfromfile")
