...
class TraffixNuscCoopDataset(Custom3DDataset):
    ...
    def _evaluate_traffix_nusc(
        ...
        if verbose:
            print('Initializing traffix nuScenes detection evaluation')
