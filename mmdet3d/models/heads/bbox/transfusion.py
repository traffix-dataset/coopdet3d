...
class TransFusionHead(nn.Module):
    ...
    def forward_single(self, inputs, img_inputs, metas):
        ...
        elif self.test_cfg["dataset"] == "traffix_nusc":  # for tumtraf_i with 9 classes#
            local_max[
                :,
                7,
        ...
        elif self.test_cfg["dataset"] == "traffix_nusc_coop":  # for traffix Coop with 6 classes#
            local_max[
                :,
                4,
    ...
    def get_bboxes(self, preds_dicts, metas, img=None, rescale=False, for_roi=False):
        ...
        for layer_id, preds_dict in enumerate(preds_dicts):
            ...
            if self.test_cfg["dataset"] == "nuScenes" or self.test_cfg["dataset"] == "traffix_nusc":
                self.tasks = [
                    dict(
                        num_class=8,
                        class_names=[],
