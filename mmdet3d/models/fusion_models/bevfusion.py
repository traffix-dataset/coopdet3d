...
def visualize_feature_map_cam(feature):
    ...
    plt.savefig(str('/home/bevfusion/viz_traffix_featmap/features/camera/feature_map_'+str(cam_plot_idx)+'.png'), bbox_inches='tight')
...
def visualize_feature_map_lidar(feature):
    ...
    gray_scale = gray_scale / feature.shape[0]
    plt.imshow(gray_scale)
    plt.savefig(str('/home/bevfusion/viz_traffix_featmap/features/lidar/feature_map_'+str(lid_plot_idx)+'.png'), bbox_inches='tight')
