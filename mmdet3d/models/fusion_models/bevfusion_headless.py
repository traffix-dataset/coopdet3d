...
def visualize_feature_map_cam(feature):
    ...
    plt.savefig(str('/home/bevfusion/viz_traffix_featmap/features/camera/feature_map_cam_vehicle'+str(cam_plot_idx)+'.png'), bbox_inches='tight')
...
def visualize_feature_map_lidar_vehicle(feature):
    ...
    gray_scale = gray_scale / feature.shape[0]
    plt.imshow(gray_scale)
    plt.savefig(str('/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/feature_map_lidonly_'+str(v_lid_plot_idx)+'.png'), bbox_inches='tight')
...
def visualize_feature_map_lidar_infra(feature):
    ...
    gray_scale = gray_scale / feature.shape[0]
    plt.imshow(gray_scale)
    plt.savefig(str('/home/bevfusion/viz_traffix_featmap/features/lidar/infra/feature_map_'+str(i_lid_plot_idx)+'.png'), bbox_inches='tight')
...
def visualize_feature_map_lidar_fused(feature):
    ...
    gray_scale = gray_scale / feature.shape[0]
    plt.imshow(gray_scale)
    plt.savefig(str('/home/bevfusion/viz_traffix_featmap/features/lidar/fused/feature_map_fused_'+str(lid_plot_idx)+'.png'), bbox_inches='tight')
...
class BEVFusionHeadless(BaseModule):
    ...
    def extract_lidar_features(self, x) -> torch.Tensor:
        ...
        # print("Voxelize in")
        # visualize_feature_lidar(x[0].detach().cpu().numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/val_prevoxi")
    ...
    def forward_single(
        ...
        **kwargs,
        ...
        if node == "vehicle":
            ...
            #   visualize_feature_lidar(points[0].detach().cpu().numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/val_firstinv2i")
            ...
            for sensor in (
                ...
                # TODO: add param to visualize feature maps
                # print("LiDAR in 1")
                # visualize_feature_lidar(points[0].detach().cpu().numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/val_lidarinloop")
                ...
                if sensor == "camera":
                    ...
                    # TODO: add param to visualize feature maps
                    # print("LiDAR in 2")
                    # visualize_feature_lidar(points[0].detach().cpu().numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/vehicle/val_lidarin")
            ...
            # TODO: add param to visualize feature maps
            # print("After headless v2i")
            # visualize_feature_lidar(points[0].detach().cpu().numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/infra/val_firstinv2ii")
