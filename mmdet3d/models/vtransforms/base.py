...
def visualize_feature_map_lidar_fused(feature):
    ...
    plt.savefig(str('/home/bevfusion/viz_traffix_featmap/features/lidar/fused/feature_map_' + str(lid_plot_idx) + '.png'),
                bbox_inches='tight')
    ...
    def forward(
        ...
        for b in range(batch_size):
            if self.vehicle:
                ...
                # if not training:
                # visualize_feature_lidar(cur_coords.detach().cpu().numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/infra/orival")
                ...
                # if not training:
                # visualize_feature_lidar(cur_coords.transpose(1, 0).detach().cpu().numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/infra/auginversed")
                ...
                # if not training:
                # visualize_feature_lidar(cur_coords.detach().cpu().numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/infra/i2vval")
                ...
                # visualize_feature_lidar(test_coords.transpose(1, 0).detach().cpu().numpy(), "/home/bevfusion/viz_traffix_featmap/features/lidar/infra/testrevert")
